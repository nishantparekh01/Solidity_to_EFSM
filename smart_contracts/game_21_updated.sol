...
contract TwentyOneGame {
    ...
    function move(uint8 value) public {
        ...
        //require(value >= 1 && value <= 3,
            "Move out of range. Must be between 1 and 3."); // can be translated as value == 1 || value == 2 || value == 3
    ...
    //    return player2; // this was added after the if condition was commented out
    //    if (player == player1) {
    //        return player2;
